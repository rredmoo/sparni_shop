        ...
        <div class="container">
          <div class="gallery">
            ...
            <figure class="gallery__item gallery__item--2">
              <img src={rightImageTop} alt="Gallery image 2" class="gallery__img" />
            </figure>
            <figure class="gallery__item gallery__item--3">
              <img src={rightImageBottomLeft} alt="Gallery image 3" class="gallery__img" />
            </figure>
            <figure class="gallery__item gallery__item--4">
              <img src={rightImageBottomRight} alt="Gallery image 4" class="gallery__img" />
            </figure>
          </div>
        </div>
        <h1>{t('storeHeader')}</h1>\
