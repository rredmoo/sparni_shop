...
//ID
    ...
    public Pirceja_Dati(String vards, String uzvards, String epasts, String personas_kods, String swift_kods, String bankas_konts, String adrese){
     setVards(vards);
     setUzvards(uzvards);
     setEpasts(epasts);
